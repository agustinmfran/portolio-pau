...
function Sierras() {
  ...
  const lang = () => {
    switch (locale) {
      case "es":
        return es.projectsPage.sierras;
      case "fr":
        return fr.projectsPage.sierras;
      default:
        return en.projectsPage.sierras;
    }
  };
  const images = [
    "/projects/sierras/1.jpg",
    "/projects/sierras/2.jpg",
    "/projects/sierras/3.jpg",
    "/projects/sierras/4.jpg",
    "/projects/sierras/5.jpg",
    "/projects/sierras/6.jpg",
    "/projects/sierras/7.jpg",
    "/projects/sierras/8.jpg",
  ];
  return (
    <>
      <Head>
