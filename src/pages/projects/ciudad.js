...
function Ciudad() {
  ...
  const lang = () => {
    switch (locale) {
      case "es":
        return es.projectsPage.ciudad;
      case "fr":
        return fr.projectsPage.ciudad;
      default:
        return en.projectsPage.ciudad;
    }
  };
  const images = [
    "/projects/ciudad/1.jpg",
    "/projects/ciudad/2.jpg",
    "/projects/ciudad/3.jpg",
    "/projects/ciudad/4.jpg",
    "/projects/ciudad/5.jpg",
    "/projects/ciudad/6.jpg",
    "/projects/ciudad/7.jpg",
  ];
  return (
    <>
      <Head>
