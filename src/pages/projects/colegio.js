...
function Colegio() {
  ...
  const lang = () => {
    switch (locale) {
      case "es":
        return es.projectsPage.colegio;
      case "fr":
        return fr.projectsPage.colegio;
      default:
        return en.projectsPage.colegio;
    }
  };
  const images = [
    "/projects/colegio/1.jpg",
    "/projects/colegio/2.jpg",
    "/projects/colegio/3.jpg",
    "/projects/colegio/4.jpg",
  ];
  return (
    <>
      <Head>
